<script>
    ...
    OnEvent("Laptop/SetVisiblity", (Data) => {
        ...
        // Log the Data object as a stringified JSON for better readability
        ...
        // Log the preferences object to check its content
        //console.log("LaptopPreferences set to: ", JSON.stringify(Data.Preferences));

        LaptopPreferences.set(Data.Preferences);
        LaptopType = Data.Type;

        // Log PlayerData for debugging
        //console.log("PlayerData set to: ", JSON.stringify(Data.PlayerData));
    ...
    <div class="laptop-container" style="background-image: url({$LaptopPreferences.background ? $LaptopPreferences.background : './images/wallpapers/default.png'})">
        ...
        <div class="laptop-container-taskbar">
            <div class="laptop-container-taskbar-row">
                ...
                <div class="laptop-taskbar-app {$FocusedApp == "Internet" ? "active" : ""}" on:keyup on:click={() => { SetCurrentApps({ Id: "Internet", Label: "Internet Explorer", Image: "internetexplorer.svg", IsSvg: true, IsFake: false, RequiresVPN: false, Hidden: true }) }}>
