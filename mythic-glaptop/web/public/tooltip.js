(function($) {
    ...
    Hint.prototype = {
        ...
        calculatePosition: function() {
            ...
            // ToDo: Fix so tooltip doesn't go out screen, this does the job, except the arrow beneath the tooltip is offset..
            // if (tp.left + actualWidth > $(window).width()) {
            //     tp.left = $(window).width() - actualWidth
            //     $tip.find('.tooltip-css-arrow')[0].style = "left: " + (actualWidth / 2) + "px" // Do some calculations here to get original arrow spot?
            // }
    ...
    $.hint.defaults = {
        ...
        maxWidth: 0 // data-tooltip-max-width
    }
